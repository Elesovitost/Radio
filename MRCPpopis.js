...
var MRCervicalPOPText = document.getElementById("MRCervicalPOPText");
...
if (X01PRText === "0") {
 ...
 X01stenozyP += "Mírný tlak na durální vak zprava. ";
 X01stenPR = "Mírný tlak na durální vak zprava ";
} else if (X01PRText === "2") {
 X01stenozyP += "Útlak durálního vaku zprava. ";
 X01stenPR = "Útlak durálního vaku zprava ";
} else if (X01PRText === "3") {
 X01stenozyP += "Komprese míchy zprava. ";
 X01stenPR = "Komprese míchy zprava ";
} 
...
if (X01LRText === "0") {
 ...
 X01stenozyP += "Mírný tlak na durální vak zleva. ";
 X01stenLR = "Mírný tlak na durální vak zleva ";
} else if (X01LRText === "2") {
 X01stenozyP += "Útlak durálního vaku zleva. ";
 X01stenLR = "Útlak durálního vaku zleva ";
} else if (X01LRText === "3") {
 X01stenozyP += "Komprese míchy zleva. ";
 X01stenLR = "Komprese míchy zleva ";
} 
...
`;
let codeForX12 = codeForX01.replace(/X01/g, 'X12').replace(/Level0\/1/g, 'C3/4').replace(/X0/g, 'X1').replace(/Root0/g, 'C4').replace(/Root1/g, 'C5');
let codeForX23 = codeForX01.replace(/X01/g, 'X23').replace(/Level0\/1/g, 'C4/5').replace(/X0/g, 'X2').replace(/Root0/g, 'C5').replace(/Root1/g, 'C6');
let codeForX34 = codeForX01.replace(/X01/g, 'X34').replace(/Level0\/1/g, 'C5/6').replace(/X0/g, 'X3').replace(/Root0/g, 'C6').replace(/Root1/g, 'C7');
let codeForX45 = codeForX01.replace(/X01/g, 'X45').replace(/Level0\/1/g, 'C6/7').replace(/X0/g, 'X4').replace(/Root0/g, 'C7').replace(/Root1/g, 'C8');
let codeForX56 = codeForX01.replace(/X01/g, 'X56').replace(/Level0\/1/g, 'C7/T1').replace(/X0/g, 'X5').replace(/Root0/g, 'C8').replace(/Root1/g, 'T1');
      codeForX01 = codeForX01.replace(/X01/g, 'X01').replace(/Level0\/1/g, 'C2/3').replace(/X0/g, 'X0').replace(/Root0/g, 'C3').replace(/Root1/g, 'C4');
...
MRCervicalSEKVText.value = "C páteř v sag T1W, T2W, STIR, tra T2W, (event. tra T1W dle potřeby). ";
...
MRCervicalRESText.value = MRCervicalRESText.value.replace(/,\s((?!C[1-7]|T1)[A-ZÚ])/g, function(fullMatch, groupMatch) {    return ', ' + groupMatch.toLowerCase();}); // po čárce malé písmeno, nevztahuje se na X1-5 a X6.
