...
const ORGAN_MAP = {
    ...
    "Mozek": { name: "Mozek", table: "group:brain_wml_main,brain_atr_main,brain_cpa_main,brain_sella_main,brain_sinus_main", regions: ['brain'] },
    ...
    "Siny": { name: "Siny", resolveTable: (activeRegions) => activeRegions.includes('brain') ? 'brain_sinus_main' : 'neck_sinus_main', regions: ['brain', 'neck'] },
    ...
    // Pořadí v levém panelu = pořadí klíčů zde (stejné jako pořadí sekcí ve Findings).
    "Plíce": { name: "Plíce a pleura", table: "group:thorax_plice_main,thorax_pleura_main", regions: ['thorax'] },
    ...
    "Aorta": { name: "Velké cévy", table: "abdomen_velke_cevy_main", regions: ['abdomen'] },
    ...
    "LTC": { name: "LTC", table: "knee_lat_comp_main", regions: ['knee'] },
    ...
    "LCA": { name: "LCA", table: "knee_acl_main", regions: ['knee'] },
    "LCP": { name: "LCP", table: "knee_pcl_main", regions: ['knee'] },
    "MCL": { name: "LCM", table: "knee_mcl_main", regions: ['knee'] },
    "LCL": { name: "LCL", table: "knee_lcl_main", regions: ['knee'] },
    "Fibula": { name: "Hlavička fibuly", table: "knee_bones_main", regions: ['knee'] },
    "Knee_bones": { name: "Skelet", table: "knee_bones_main", regions: ['knee'] },
